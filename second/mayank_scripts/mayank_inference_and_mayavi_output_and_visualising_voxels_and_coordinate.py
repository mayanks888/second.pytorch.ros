...
#num points tells us no of point inside each defines voxel
...
draw_lidar_simple(coords)
mlab.show()
# for index in range(10):
#     # v_points=voxels[index,:,:]
#     # draw_lidar_simple(v_points)
#
#     cord_nate=coords[index]
#     mlab.points3d(cord_nate[2], cord_nate[1], cord_nate[0], color=(1, 1, 1), mode='sphere', scale_factor=1)
# mlab.show()
